                        ...
                        <div id="myTabContent" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_basic"
                                ...
                                <form class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="domain">主域名 <i class="fa fa-question-circle" title="例如：https://www.onepiece.top的主域名就是onepiece.top"></i> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" name="domain" id="domain" required="required" placeholder="例如: onepiece.top"/>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" name="copyright" id="copyright" placeholder="例如：Copyright &copy; ${.now?string("yyyy")} onepiece.top All Rights Reserved"/>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                ...
                                <form class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="storage-box" id="local">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" name="localFileUrl" id="localFileUrl" required="required" placeholder="请输入文件服务器域名，如：http://file.onepiece.top/"/>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <small>请按照 <code>http://file.onepiece.me/</code> 格式填写，包含 <code>http://</code> 和末尾的 <code>/</code></small>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_setting" aria-labelledby="setting-tab">
                                <form class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dynamicTitle">动态标题 <i class="fa fa-question-circle" title="当切换浏览器tab时，在原tab上的标题。比如https://onepiece.top上的“麻溜儿回来~~~”"></i></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
