                    ...
                    <div id="social" style="margin-bottom: 45px;">
                        <div class="social-main">
                            ...
                            <div class="shang-p">
                                ...
                                <span class="shang-s">
<#--                                    PaymentUtils.show()-->
                                    <a onclick="javascript:;" style="cursor:pointer">赏</a>
                                </span>
                            </div>
                            <div class="share-sd">
                        ...
                        <#if hotList?? && (hotList?size > 0)>
                            ...
                            <li class="line-li">
                                <div class="line-container">
                                    <div class="line-left">
                                        <#if item.coverImage??>
                                            <img class="lazy-img" <#if config.lazyloadPath!>data-original<#else>src</#if>="${config.staticWebSite}/img/user.png" onerror="this.src='${config.staticWebSite}/img/default.png'"width="50" height="50" rel="external nofollow"/>
                                        <#else>
