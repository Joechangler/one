        ...
        <#else >
            <div class="col-sm-12 blog-main">
                <div class="blog-body expansion">
                    <h5 class="custom-title"><i class="fa fa-coffee fa-fw"></i><strong>友链提交</strong><small> - 点击下方</small></h5>
                    <div class="link-info">
                        <ul class="list-unstyled">
                            <li>建议完整提交</li>
                            <li>优先选择<kbd>同类原创、内容相近</kbd>的博客或网站</li>
                            <li><kbd>技术类</kbd>、<kbd>IT科技</kbd>、<kbd>互联网</kbd>、<kbd>生活</kbd></li>
