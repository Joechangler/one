                ...
                <div id="feed_widget">
                    <div class="feed-about">
                        <div class="about-main">
                            <div class="about-img"><a href="${config.wxCode}" class="showImage" title="微信公众号"><img src="https://mp.weixin.qq.com/mp/qrcode?scene=10000004&size=102&__biz=MzkzMjM4NzQ2Ng==&mid=2247483653&idx=1&sn=96453ac1ee27a1b271e55afba0bf999a&send_time=" alt="微信公众号"></a></div>
