            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12 col-md-12 col-lg-12">
                        ...
                        <p>托管于<a href="https://promotion.aliyun.com/ntms/act/ambassador/sharetouser.html?" target="_blank" title="阿里云-为了无法计算的价值" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">阿里云</a> </p>
<#--                            & <a href="https://portal.qiniu.com/" target="_blank" title="七牛云-国内领先的企业级云服务商" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">七牛云</a><#if config.recordNumber!> · <a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank" title="查看备案信息" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">${config.recordNumber}</a></#if></p>-->
                    </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col col-xs-12 col-md-12 col-lg-12">
                    <p><#if config.copyright!>${config.copyright} |</#if> Powered by OnePiece
                    <#if url?? && (url == "index")>
...
<script type="text/javascript" src="${config.staticWebSite}/js/one.core.js"></script>
<script type="text/javascript" src="${config.staticWebSite}/js/one.comment.js"></script>
<script type="text/javascript" src="${config.staticWebSite}/js/one.js"></script>
